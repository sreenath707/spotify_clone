    ...
    <div className="signUp">
      <div className="signUp__form">
        <Link to="*"><img
          ...
          alt="logo"
        /></Link>
        <div className="signUp__form__fields">
          <h1>Sign up for a free Spotify account.</h1>
          ...
          <div className="signUp__field">
            ...
            <VisibilityOffOutlinedIcon className="signUp__icon" />
          </div>
          <div className="signUp__field">
            <input type="text" placeholder="What should we call you?" />
            <AccountCircleOutlinedIcon className="signUp__icon" />
          </div>
        ...
        <div className="signUp__bottom">
          <div className="signUp__facebook">
            <FacebookRoundedIcon color="primary" className="signUp__facebook__icon"/>
            <button>Sign up with Facebook</button>
          </div>
          <p className="signUp__back">
            <a href="/">BACK</a>
          </p>
          <h6>
            Already on Spotify? <Link to="/signin"><a href="/">LOGIN</a></Link>
          </h6>
        </div>
      </div>
    </div>
